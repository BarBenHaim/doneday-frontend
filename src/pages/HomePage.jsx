        ...
        <section className='home-page-body'>
            ...
            <main className='main-container-page-home'>
                <div className='text-content'>
                    ...
                    <p className='txt'>
                        Streamline workflows and gain clear visibility across teams to make strategic decisions with
                        confidence.
                    </p>
                    ...
                    <p className='small-txt'>No credit card needed ✦ Unlimited time on Free plan</p>
                </div>
            ...
            <div>
                <img className='monday-pics-container' src={Image6} alt='Project 6' />
                <h2 className='sponser-title'>Trusted by 225,000+ customers, from startups to enterprises</h2>
