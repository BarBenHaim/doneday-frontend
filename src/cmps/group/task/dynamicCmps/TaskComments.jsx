...
import { Dialog, DialogContentContainer, Button, TextArea, Avatar } from 'monday-ui-react-core'
import { AddUpdate, Emoji, Gif, Home, Mention, Replay, ThumbsUp } from 'monday-ui-react-core/icons'
                                ...
                                <div className='tabs'>
                                    ...
                                    <div className='tab-buttons'>
                                        <div className='update-icon'>
                                            <Home />
                                            <button onClick={() => setIsActivityLog(false)} className='tab'>
                                                Updates
                                            </button>
                                        </div>
                                        <button className='tab'>Files</button>
                                        <button onClick={() => setIsActivityLog(true)} className='tab'>
                                            Activity Log
                                        </button>
                                    </div>
                                </div>
                                ...
                                {!task.comments || task.comments.length === 0 ? (
                                    <div className='no-update-container'>
                                        ...
                                        {isWriteActive && (
                                            <>
                                                <TextArea
                                                    className={`custom-textarea ${isActivityLog ? 'hidden' : ''}`}
                                                ...
                                                <div className={`modal-footer ${isActivityLog ? 'hidden' : ''}`}>
                                        ...
                                        <img
                                            className={`no-update-img ${isActivityLog ? 'hidden' : ''}`}
                                    ...
                                    <>
                                        {' '}
                                        <div className={`comments ${isActivityLog ? 'hidden' : ''}`}>
                                            <>
                                                <TextArea
                                                    size='large'
