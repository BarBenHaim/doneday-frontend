...
import { AddUpdate, Emoji, Gif, Mention, Replay, ThumbsUp } from 'monday-ui-react-core/icons'
                    ...
                    <DialogContentContainer>
                        <div className='modal-content'>
                            ...
                            <div className='text-area'>
                                {!isWriteActive ? (
                                    <div>
                                        <button className='write-btn' onClick={() => setIsWtireActive(true)}>
                                            Write an update...
                                        </button>
                                    </div>
                                ) : (
                                    ...
                                    <div key={index} className='comment'>
                                        ...
                                        <div className='comment-body'>
                                            <div className='comment-header'>
                                                <span className='comment-author'>{comment.byMember.fullname}</span>
